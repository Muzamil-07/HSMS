...
const ViewAssignedPlot=() => {
  return (
    <>
      <Pageheader
        title='Information about Plot assign to user'
        subtitle='In this section you can view assigned plot detail'
        title_array={[ 'dashboard', 'plot', 'assign', 'detail' ]}
        add_button={false}
      />
...
export default ViewAssignedPlot;
