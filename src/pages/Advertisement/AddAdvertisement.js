...
const AddAdvertisement=() => {
  ...
  return (
    <Page title='Dashboard: Advertisement Page'>
      <Pageheader
        title='Add advertisement page'
        subtitle='In this section you will add new advertisment'
        title_array={[ 'dashboard', 'content', 'advertisement','add' ]}
      />
      <div style={{ paddingLeft: '2rem'}}>
        ...
        >
          ...
          <Row  style={{marginTop:50 , display:'flex',justifyContent:'end'}}>
